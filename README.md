...
6. Backend приложения будет доступно по адресу http://127.0.0.1:8000/

7. Инструкции будут доступны по адресам http://127.0.0.1:8000/swagger/ и http://127.0.0.1:8000/redoc/
